      ...
      <div style={{ background: '#FFFFFF', border: '1px solid rgba(0,51,102,0.38)', borderRadius: '12px', padding: '20px', marginBottom: '28px' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '16px' }}>
          {[
            ...
            { id: 'MOD-07', name: 'USFD Waveform Oscillometer Analyzer', type: 'Signal Processing Neural Net', accuracy: '97.5%', status: 'PRODUCTION', desc: 'Processes 144 Hz ultrasonic rail flaw echoes to detect internal transverse fatigue cracks.' },
