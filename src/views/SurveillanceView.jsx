          ...
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '16px', flexWrap: 'wrap', gap: '12px' }}>
            ...
            <button
              ...
              style={{
                ...
                fontWeight: '700', fontSize: '0.82rem', border: 'none', cursor: 'pointer', box-shadow: '0 2px 8px rgba(0,51,102,0.2)'
              }}
            >
            ...
            <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '0.83rem' }}>
              <thead>
                <tr style={{ background: '#F8FAFC', borderBottom: '2px solid #E2E8F0', textAlign: 'left', color: '#475569' }}>
                  <th style={{ padding: '10px 14px' }}>Inspection ID</th>
                  <th style={{ padding: '10px 14px' }}>Title & Asset</th>
                  <th style={{ padding: '10px 14px' }}>Location / Section</th>
                  <th style={{ padding: '10px 14px' }}>Method</th>
                  <th style={{ padding: '10px 14px' }}>Technician</th>
                  <th style={{ padding: '10px 14px' }}>Status</th>
                  <th style={{ padding: '10px 14px' }}>Result / Score</th>
                </tr>
              </thead>
              <tbody>
                {inspections
                  ...
                  .map(i => (
                    <tr key={i.id} style={{ borderBottom: '1px solid #F1F5F9' }}>
                      <td style={{ padding: '12px 14px', fontWeight: '700', color: '#003366', fontFamily: 'monospace' }}>{i.id}</td>
                      ...
                      <td style={{ padding: '12px 14px', color: '#0056B3', fontWeight: '600' }}>{i.method}</td>
                      <td style={{ padding: '12px 14px', color: '#334155' }}>{i.technician}</td>
                      <td style={{ padding: '12px 14px' }}>
                        <span style={{
          ...
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '16px', flexWrap: 'wrap', gap: '12px' }}>
            ...
            <button
              ...
              style={{
                ...
                fontWeight: '700', fontSize: '0.82rem', border: 'none', cursor: 'pointer', box-shadow: '0 2px 8px rgba(217,83,30,0.25)'
              }}
            >
            ...
            <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '0.83rem' }}>
              <thead>
                <tr style={{ background: '#F8FAFC', borderBottom: '2px solid #E2E8F0', textAlign: 'left', color: '#475569' }}>
                  ...
                  <th style={{ padding: '10px 14px' }}>Type & Description</th>
                  <th style={{ padding: '10px 14px' }}>Asset & Location</th>
                  <th style={{ padding: '10px 14px' }}>Severity / Priority</th>
                  <th style={{ padding: '10px 14px' }}>Downtime</th>
                  <th style={{ padding: '10px 14px' }}>Status</th>
                  ...
                  .map(i => (
                    <tr key={i.id} style={{ borderBottom: '1px solid #F1F5F9' }}>
                      ...
                      <td style={{ padding: '12px 14px' }}>
                        ...
                        <div style={{ fontSize: '0.73rem', color: '#64748B', maxWidth: '280px' }}>{i.summary}</div>
                      </td>
                      <td style={{ padding: '12px 14px' }}>
                      ...
                      <td style={{ padding: '12px 14px', fontWeight: '600', color: '#D9531E' }}>{i.downtime}</td>
                      <td style={{ padding: '12px 14px' }}>
                        <span style={{
                          padding: '3px 8px', borderRadius: '4px', fontSize: '0.72rem', fontWeight: '700',
                      ...
                      <td style={{ padding: '12px 14px', fontSize: '0.75rem', color: '#475569' }}>
                        <div>{i.operator}</div>
                        <div style={{ fontSize: '0.68rem', color: '#94A3B8' }}>{i.reportedAt}</div>
                      </td>
                    </tr>
                  ))}
              </tbody>
